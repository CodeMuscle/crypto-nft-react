...
const NFTDetails = () => {
  ...
  return (
    <div className="relative flex justify-center md:flex-col min-h-screen">
      <div className="relative flex-1 flexCenter sm:px-4 p-12 border-r md:border-r-0 md:border-b dark:border-nft-black-1 border-nft-grey-1">
      ...
      <div className="flex-1 justify-start sm:px-4 p-12 sm:pb-4">
        ...
        <div className="mt-10 flex flex-col">
          <div className="w-full border-p dark:border-nft-black-1 border-nft-gray-1 flex flex-row">
        ...
        <div className="flex flex-row sm:flex-col mt-10">
          {currentAccount === nft.seller.toLowerCase() ? (
            <p className="font-poppins dark:text-white text-nft-black-1 text-base minlg:text-base font-normal border-gray p-2">
      ...
      {successModal && (
        <Modal
          ...
          body={(
            <div
              className="flex flexCenter flex-col text-center"
